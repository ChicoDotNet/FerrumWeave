use ferrumweave::managed::{
    method_calls_instance_member_ref, resolve_public_instance_member_ref, resolve_public_static_method,
};
...
fn resolved_public_instance_member_ref_is_the_callvirt_target_in_emitted_il() {
    ...
    let instance_method = resolve_public_instance_member_ref(&image, "System", "Object", "ToString")
