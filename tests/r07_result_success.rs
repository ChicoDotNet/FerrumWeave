...
#[test]
fn result_success_crosses_managed_boundary_as_declared_success_value() {
    ...
    fs::copy(&assembly, consumer.join(PROBE_ASSEMBLY_FILE))
        .expect("place Rust-produced managed assembly beside R07 Result success consumer project");
...
"#,
    ...
    assert!(
        run.status.success(),
        "C# consumer must execute the Rust-defined Result success projection:\n{}\n{}",
